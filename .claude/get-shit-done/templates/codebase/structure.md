...
- Usage: Reference from command with `@D:/Proyectos/sistemaInmobiliaria/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/Proyectos/sistemaInmobiliaria/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Proyectos/sistemaInmobiliaria/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

...
Reference full template: `D:/Proyectos/sistemaInmobiliaria/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Proyectos/sistemaInmobiliaria/.claude/get-shit-done/templates/state.md`.
